...
sap.ui.controller("sap.ui.project.e2etm.controller.ForexSalesReport", {
...
//	=======================================EVENT==============================================
	...
	if(evt.getParameter("name")=="home"){
		...
		} else if(evt.getParameter("name")=="forexsalesreport") {
...
//	}
	...
	oExport.saveFile("Forex Sales Report").always(function() {
		this.destroy();
	});
	},
});