jQuery.sap.declare("sap.ui.project.e2etm.controls.customFlowStage");
//$.sap.includeStyleSheet("path/to/css/file");

sap.ui.core.Control.extend("sap.ui.project.e2etm.controls.customFlowStage", {
	...
	metadata: {
		...
		aggregations: {
			items: {
				type: "sap.ui.project.e2etm.controls.stageItem",
				multiple: true,
				visibility: "public"
			}
		}
